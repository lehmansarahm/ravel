...
set yrange [0:1]
set style data histograms
plot 2 t 'copy path (cp)' lw 6 lc rgb "#92c5de", \
    2 t 'write to table (wt)' lw 6 lc rgb "#0571b0", \
    2 t 'trigger and/or rule (tr)' lw 6 lc rgb "#f4a582"
